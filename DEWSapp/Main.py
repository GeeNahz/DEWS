...
def main_section(oceanT, itcz10p, nash, litcz10, sumpos10, sumneg10, itczratio, neg10max, pos10max):
    ...
    if (oceanT == 'AVERAGE') and (itcz10p == 'NORMAL') and (litcz10 is not 12):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'AVERAGE' and itcz10p == 'NORMAL' and litcz10 == 12 and sumneg10 < 1):
        drought_index = 'MODERATE DROUGHT'
        return drought_index

    if (oceanT == 'AVERAGE' and itcz10p == 'NORMAL' and litcz10 == 12 and nash < 0.7):
        drought_index = 'SEVERE DROUGHT'
        return drought_index

    if (oceanT == 'COLD' and itcz10p == 'EXTREME SOUTH'):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'COLD' and itcz10p == 'NORMAL'):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'SEVERE SOUTH' and itczratio < 1):
        drought_index = 'NO DROUGHT'
        return drought_index
    ...
    if (oceanT == 'VERY WARM' and itcz10p == 'NORMAL'):
        drought_index = 'MODERATE DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'MODERATE SOUTH'):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME NORTH'):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash >= 0.85 and sumneg10 > 5.3 and sumpos10 <4):
        drought_index = 'NO DROUGHT'
        return drought_index
    ...
    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash < 0.85 and neg10max > 7):
        drought_index = 'MODERATE DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash <= 0.8 and neg10max < 7):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'WARM' and itcz10p == 'EXTREME SOUTH' and itczratio > 1):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'WARM' and itcz10p == 'EXTREME SOUTH' and itczratio < 1 and litcz10 == 12):
        drought_index = 'MILD DROUGHT'
        return drought_index

    if (oceanT == 'WARM' and itcz10p == 'EXTREME SOUTH' and itczratio < 1 and litcz10 is not 12):
        drought_index = 'MODERATE DROUGHT'
        return drought_index
    ...
    if (oceanT == 'AVERAGE' and itcz10p == 'EXTREME SOUTH'):
        drought_index = 'NO DROUGHT'
        return drought_index
    ...
    if (oceanT == 'VERY WARM' and itcz10p == 'NORMAL' and itczratio > 10):
        drought_index = 'NO DROUGHT'
        return drought_index
    ...
    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash < 0.3):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash < 0.85 and litcz10 == 3 and neg10max >= 8.5):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash < 0.85 and litcz10 == 3 and neg10max < 8.5 and itczratio > 2):
        drought_index = 'MILD DROUGHT'
        return drought_index
    ...
    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash >= 0.85 and litcz10 == 2 and neg10max < 3.5 and sumneg10 > 13):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash >= 0.85 and litcz10 == 2 and neg10max > 3.5):
        drought_index = 'MILD DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash >= 0.85 and litcz10 == 1):
        drought_index = 'NO DROUGHT'
        return drought_index

    if (oceanT == 'VERY WARM' and itcz10p == 'EXTREME SOUTH' and nash < 0.6):
        drought_index = 'MILD DROUGHT'
        return drought_index
