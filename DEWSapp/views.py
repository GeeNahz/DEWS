...
from .serializer import (
    ...
    PredictionModelSerializerResponse,
    SpeiSerializer,
    TextSerializer,
)
from .dataset import (
...
class PredictGenericAPIView(GenericAPIView):
    ...
    def get(self, request):
        ...
        SPEIA, SPEIM, SPEIJN, SPEIJY, SPEIAG, SPEIS, SPEIO, region = spei_predict(
            lga, year
        )

        results = PredictDetails(
            year,
            drought_index,
            oceanTemp,
            climate_direction,
...
@response_schema(serializer=PredictionModelSerializerResponse)
class PredictModelAPIView(APIView):
    ...
    def post(self, request, format=None):
        ...
        payload = main(month, year)

        serializer_data = PredictionModelSerializerResponse(payload)
